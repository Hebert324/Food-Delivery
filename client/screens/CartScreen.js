    ...
    return (
        <View className=" bg-white flex-1">
            ...
            <View style={{backgroundColor: themeColors.bgColor(0.2)}} className="flex-row px-4 items-center">
                ...
                <Text className="flex-1 pl-4">Entregue em 20-30 minutos</Text>
                <TouchableOpacity>
                    <Text style={{color: themeColors.text}} className="font-bold">Mudar</Text>
                </TouchableOpacity>
            </View>
            ...
            <View style={{backgroundColor: themeColors.bgColor(0.2)}} className=" p-6 px-8 rounded-t-3xl space-y-4">
                ...
                <View className="flex-row justify-between">
                    <Text className="font-extrabold">Total de pedidos</Text>
                ...
                <View>
                    <TouchableOpacity
                        ...
                        <Text className="text-white text-center font-bold text-lg">Faça o pedido</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </View>
